...
WORDING : Dict[str, Any] =\
{
	...
	'help':
	{
		...
		# training
		'training_model': 'choose the training architecture',
		'training_base_model': 'choose the pre-trained model to start from',
		'training_output_model': 'specify the name of the resulting model file',
		'training_epochs': 'specify the total number of training passes',
		'training_batch_size': 'specify the number of samples processed at once',
		'training_learning_rate': 'specify the step size at each iteration',
		'training_save_interval': 'specify the frequency of saving checkpoints',
		# uis
	...
	'uis':
	{
		...
		'training_batch_size_slider': 'TRAINING BATCH SIZE',
		'training_base_model_dropdown': 'TRAINING BASE MODEL',
		'training_epochs_slider': 'TRAINING EPOCHS',
		'training_learning_rate_number': 'TRAINING LEARNING RATE',
		'training_model_dropdown': 'TRAINING MODEL',
		'training_output_model_textbox': 'TRAINING OUTPUT MODEL',
		'training_save_interval_slider': 'TRAINING SAVE INTERVAL',
